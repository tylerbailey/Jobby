...
namespace Jobby.Infrastructure.Migrations
{
    ...
    [Migration("20260712163403_EmailNotificaitons")]
    partial class EmailNotificaitons
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jobby.Server.Entities.AppStage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Jobby.Server.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Jobby.Server.Entities.JobApp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jobby.Server.Entities.JobHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jobby.Server.Entities.LocationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Jobby.Server.Entities.JobApp", b =>
                {
                    b.HasOne("Jobby.Server.Entities.LocationType", "LocationType")
                        .WithMany()
            ...
            modelBuilder.Entity("Jobby.Server.Entities.JobEvent", b =>
                {
                    b.HasOne("Jobby.Server.Entities.JobApp", "JobApp")
                        .WithMany("JobEvents")
                        .HasForeignKey("AppId");

                    b.HasOne("Jobby.Server.Entities.Recruiter", "Recruiter")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Jobby.Server.Entities.ApplicationUser", null)
                        .WithMany()
