        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobPostingUrl = table.Column<string>(type: "varchar(256)", nullable: true),
                    Address = table.Column<string>(type: "varchar(256)", nullable: true),
                    Salary = table.Column<int>(type: "int", nullable: true),
                    StageId = table.Column<int>(type: "int", nullable: false),
                    LocationTypeId = table.Column<int>(type: "int", nullable: false),
                    Applied = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Upcoming = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpcomingType = table.Column<string>(type: "varchar(16)", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Modified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Disabled = table.Column<bool>(type: "bit", nullable: false)
                },
