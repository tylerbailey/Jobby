...
public interface ICalendarEventService
{
    ...
    Task CreateEventAsync(JobEventDto jobEvent, string userId);
    ...
    Task<List<JobEventDto>> GetUserEventsAsync(string userId);
}
